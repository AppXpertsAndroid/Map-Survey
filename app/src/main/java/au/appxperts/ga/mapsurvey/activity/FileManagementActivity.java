...
import au.appxperts.ga.mapsurvey.CustomDialog;
...
public class FileManagementActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.EDP).setOnClickListener(nextClick(getMIntent(getString(R.string.export_data_package), ExportActivity.class),false));
        findViewById(R.id.ISDP).setOnClickListener(nextClick(getMIntent(getString(R.string.title_populatetemplateactivity), PopulateTemplateActivity.class),false));
