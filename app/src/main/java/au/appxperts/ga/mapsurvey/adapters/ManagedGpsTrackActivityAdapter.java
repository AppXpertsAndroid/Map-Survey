 ...
 */
public class ManagedGpsTrackActivityAdapter extends RecyclerView.Adapter<GridItems> {


    private List<String> feedItemList;

    public ManagedGpsTrackActivityAdapter(Context context, List<String> feedItemList) {
